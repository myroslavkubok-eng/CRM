...
export function ShareSalonModal({ 
  ...
  isOpen, 
  onClose 
}: ShareSalonModalProps) {
  if (!isOpen) return null;

  const url = window.location.href;
  const text = `Check out ${salonName} on Katia! ${salonRating}⭐ rated salon in ${salonLocation}`;
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h3 className="text-xl font-bold text-gray-900">Share Salon</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-3">
          <p className="text-sm text-gray-600 mb-4">
            Share {salonName} with your friends
          </p>
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-sm text-gray-600">Share via Telegram</p>
            </div>
          </button>
          ...
          >
            <div className="w-12 h-12 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-sm text-gray-600">Copy link to share</p>
            </div>
          </button>
          ...
          <button
            ...
            className="w-full flex items-center gap-4 p-4 border-2 border-gray-200 rounded-xl hover:border-blue-600 hover:bg-blue-50 transition-all group"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-4 p-4 border-2 border-purple-200 bg-purple-50 rounded-xl hover:border-purple-400 hover:bg-purple-100 transition-all group"
          >
