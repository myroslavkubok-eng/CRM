...
export function ShareModal({ 
  ...
  const handleShare = (platform: string) => {
    ...
    switch (platform) {
      ...
      case 'instagram':
        ...
        handleCopyLink();
        toast.info('Link copied! You can paste it in Instagram');
        return;
      case 'copy':
        handleCopyLink();
        return;
  ...
  const modalContent = (
    <div 
      ...
      onClick={(e) => {
        // Закрываем при клике на backdrop
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-gray-500">Share via Telegram</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left flex-1">
                ...
                <div className="text-sm text-gray-500">Copy link to share</div>
              </div>
            </button>
            ...
            <button
              ...
              className="w-full flex items-center gap-4 p-4 rounded-xl border-2 border-blue-600 hover:border-blue-700 hover:bg-blue-50 transition-all group bg-blue-50"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-purple-500 hover:bg-purple-50 transition-all group bg-purple-50/50"
            >
